...
import (
	...
	"wq-fotune-backend/internal/common-srv/cache"
	"wq-fotune-backend/internal/common-srv/dao"
...
func (c *CommonHandler) PushProfitImageOss(ctx context.Context, req *pb.PushImageReq, resp *pb.ImageResp) error {
...
func (c *CommonHandler) GetUserRateRank(ctx context.Context, e *empty.Empty, resp *pb.UserRateRankResp) error {
...
func (c *CommonHandler) GetUserRateYearRank(ctx context.Context, e *empty.Empty, resp *pb.UserRateRankResp) error {
...
func (c *CommonHandler) GetAppVersion(ctx context.Context, req *pb.VersionReq, resp *pb.AppVersion) error {
...
func NewCommonHandler() *CommonHandler {
	handler := &CommonHandler{dao: dao.New(), cacheSrv: cache.NewService()}
	return handler
}

func (c *CommonHandler) Carousel(ctx context.Context, req *empty.Empty, resp *pb.CarouselList) error {
...
func (c *CommonHandler) CustomerService(ctx context.Context, req *empty.Empty, resp *pb.ContractAddr) error {
