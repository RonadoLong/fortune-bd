...
import (
	...
	"wq-fotune-backend/internal/exchange-srv/cron"
	"wq-fotune-backend/internal/exchange-srv/handler"
	pd "wq-fotune-backend/internal/exchange-srv/proto"
)
...
func main() {
	...
	logger.Infof("%s internal run successful", env.EXCHANGE_ORDER_SRV_NAME)
