...
//func (e *ExOrderService) GetStrategyList(ctx context.Context, req *pb.StrategyReq, resp *pb.StrategyList) error {
...
//func (e *ExOrderService) GetStrategy(ctx context.Context, req *pb.GetStrategyDetail, resp *pb.Strategy) error {
