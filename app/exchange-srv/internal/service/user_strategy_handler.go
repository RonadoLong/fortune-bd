...
//func (e *ExOrderService) GetUserStrategyList(ctx context.Context, req *pb.GetStrategyReq, resp *pb.UserStrategyListResp) error {
...
//func (e *ExOrderService) SetUserStrategyApi(ctx context.Context, req *pb.SetUserStrategyApiReq, resp *empty.Empty) error {
//	return e.exOrderSrv.SetUserStrategyApi(req.UserId, req.StrategyId, req.ApiKey)
//}
//
//func (e *ExOrderService) SetUserStrategyBalance(ctx context.Context, req *pb.SetUserStrategyBalanceReq, resp *empty.Empty) error {
//	balance := fmt.Sprintf("%v", req.Balance)
//	return e.exOrderSrv.SetUserStrategyBalance(req.UserId, req.StrategyId, balance)
//}
//
//func (e *ExOrderService) GetUserStrategyDetail(ctx context.Context, req *pb.UserStrategyDetailReq, resp *pb.UserStrategy) error {
...
//func (e *ExOrderService) CreateStrategy(ctx context.Context, req *pb.CreateStrategyReq, resp *empty.Empty) error {
...
//func (e *ExOrderService) RunUserStrategy(ctx context.Context, req *pb.UserStrategyRunReq, resp *empty.Empty) error {
