...
func (e *ExOrderHandler) ExChangeInfo(ctx context.Context, req *empty.Empty, resp *pb.ExChangeList) error {
...
func (e *ExOrderHandler) AddExchangeApi(ctx context.Context, req *pb.ExchangeApi, resp *empty.Empty) error {
	return e.exOrderSrv.AddExchangeApi(req.UserID, req.ApiKey, req.Secret, req.Passphrase, req.ExchangeID)
}

func (e *ExOrderHandler) GetExchangeApiList(ctx context.Context, req *pb.GetExApiReq, resp *pb.ExApiResp) error {
...
func (e *ExOrderHandler) GetExchangePos(ctx context.Context, req *pb.GetExchangePosReq, resp *pb.ExchangePosResp) error {
	//获取持有币种的账户资产 先支持okex
...
func (e *ExOrderHandler) UpdateExchangeApi(ctx context.Context, req *pb.UpdateExchangeApiReq, resp *empty.Empty) error {
	return e.exOrderSrv.UpdateExchangeApi(req.UserID, req.ApiKey, req.Secret, req.Passphrase, req.ExchangeID, req.ApiID)
}

func (e *ExOrderHandler) DeleteExchangeApi(ctx context.Context, req *pb.UserApiReq, resp *empty.Empty) error {
	return e.exOrderSrv.DeleteExchangeApi(req.UserId, req.ApiID)
}

func (e *ExOrderHandler) GetApiKeyInfo(ctx context.Context, req *pb.UserApiKeyReq, resp *pb.ExchangeApiResp) error {
...
func (e *ExOrderHandler) GetAssetsByAllApiKey(ctx context.Context, req *pb.GetExApiReq, resp *pb.AssertsResp) error {
	resp.Asserts = "0(USDT)"
	resp.Profit = "0"
