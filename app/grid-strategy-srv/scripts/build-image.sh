...
# 配置文件位置
cp ./wq-grid-strategy $SCRIPT_PATH/wq-grid-strategy
cp ./config/conf.toml $SCRIPT_PATH/conf.toml
cp ./config/confPro.toml $SCRIPT_PATH/confPro.toml
...
rm $SCRIPT_PATH/wq-grid-strategy
rm $SCRIPT_PATH/conf.toml
rm $SCRIPT_PATH/confPro.toml