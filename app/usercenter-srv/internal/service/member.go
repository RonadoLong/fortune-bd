...
// GetMembers 获取会员
func (u *UserService) GetMembers(ctx context.Context, req *empty.Empty, resp *fotune_srv_user.GetMembersResp) error {
...
func (u *UserService) GetPaymentMethod(ctx context.Context, req *empty.Empty, resp *fotune_srv_user.GetPaymentMethodResp) error {
