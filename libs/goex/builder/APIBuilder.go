...
import (
	...
	"wq-fotune-backend/pkg/goex/bigone"
	"wq-fotune-backend/pkg/goex/binance"
	"wq-fotune-backend/pkg/goex/bitfinex"
	"wq-fotune-backend/pkg/goex/bithumb"
	"wq-fotune-backend/pkg/goex/bitmex"
	"wq-fotune-backend/pkg/goex/bitstamp"
	"wq-fotune-backend/pkg/goex/bittrex"
	"wq-fotune-backend/pkg/goex/coinbene"
	"wq-fotune-backend/pkg/goex/kucoin"

	"wq-fotune-backend/pkg/goex/atop"
	//"wq-fotune-backend/pkg/goex/coin58"
	"net"
	"net/http"
	"net/url"
	"time"

	"wq-fotune-backend/pkg/goex/coinex"
	"wq-fotune-backend/pkg/goex/gateio"
	"wq-fotune-backend/pkg/goex/gdax"
	"wq-fotune-backend/pkg/goex/hitbtc"
	"wq-fotune-backend/pkg/goex/huobi"
	"wq-fotune-backend/pkg/goex/kraken"
	"wq-fotune-backend/pkg/goex/okex"
	"wq-fotune-backend/pkg/goex/poloniex"
	"wq-fotune-backend/pkg/goex/zb"
)
