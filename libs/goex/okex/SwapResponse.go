...
type BaseOrderInfo struct {
	...
	LastFillId     string    `json:"last_fill_id"`     //最新成交ID
	LastFillPrice  float64   `json:"last_fill_price"`  //最新成交价格（如果没有，推0
	LastFillAmount float64   `json:"last_fill_amount"` //最新成交数量（如果没有，推0）
